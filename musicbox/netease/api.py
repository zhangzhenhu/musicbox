...
class NetEase(object):
    ...
    def get_artist_desc(self, artist_id, offset=0, limit=50):
        # path = "/weapi/artist/desc/id={}".format(artist_id)
        url = 'https://api.imjad.cn/cloudmusic/?type=artist&id={}'.format(artist_id)
        # params = dict(offset=offset, total=True, limit=limit)
        # return self.request("POST", path, params).get("hotAlbums", [])
